...
r1, s1, r2, s2, t = symbols("r_1 s_1 r_2 s_2 t", positive = True, real = True)

f = Function('f')(r1, s1, r2, s2, t)
...
print(latex((full_laplace(x1, y1, z1, r1, s1, r1_trans, s1_trans, x2, y2, z2, r2, s2, r2_trans, s2_trans) +\
            full_laplace(x2, y2, z2, r2, s2, r2_trans, s2_trans, x1, y1, z1, r1, s1, r1_trans, s1_trans)).subs(f,Symbol(''))))
